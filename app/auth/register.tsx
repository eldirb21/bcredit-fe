...
export default function RegisterScreen() {
  ...
  const circle2X = useSharedValue(-200);
  ...
  useEffect(() => {
    ...
    circle1X.value = withDelay(100, withSpring(0, { damping: 14 }));
    circle2X.value = withDelay(200, withSpring(0, { damping: 14 }));
    headerY.value = withDelay(200, withSpring(0, { damping: 14 }));
    headerOpacity.value = withDelay(200, withTiming(1, { duration: 400 }));
    formY.value = withDelay(400, withSpring(0, { damping: 16 }));
  ...
  const inputField = (
    ...
    <View
      style={[
        styles.inputWrapper,
        focused === fieldKey && styles.inputFocused,
      ]}
    >
